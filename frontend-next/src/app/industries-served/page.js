...
const IndustriesServed = () => {
  ...
  // });
   ...
   const faqs = [
  {
    question: "How do your quarry systems adapt to changing environmental and dust regulations?",
    answer: (
      <>
  ...
  {
    question: "Can you integrate a new automation system into an older, existing mining infrastructure?",
    answer: (
      <>
  ...
  {
    question: "Do you provide on-site electrical engineering support for remote mining operations?",
    answer: (
      <>
        ...
        <Link
          href="/industrial-control-panels-mining/"
          className="text-yellow-400 hover:text-yellow-300 transition-colors"
        >
  ...
  return (
    <div className="bg-[#050505] text-white selection:bg-yellow-400 selection:text-black font-sans antialiased">
      ...
      <main>
        ...
        <section className="py-16 md:py-24 bg-[#080808] border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <ul className="space-y-4 text-gray-300">
             ...
             <FAQAccordion
             title="FAQ: Sector-Specific Engineering"
             faqs={faqs}
            />
        {/* <section className="py-16 md:py-24 bg-[#050505]">
          <div className="max-w-7xl mx-auto px-6">
        ...
        <InternalLinksSection sourcePath="/industriesserved/" />
      </main>
