            ...
            <div className="space-y-5">
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  ...
                  <Link href="/crushing-plant-electrical-integration/" className="text-yellow-400 hover:text-yellow-300">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  ...
                  <Link href="/vibrating-screen-fabrication/" className="text-yellow-400 hover:text-yellow-300">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  ...
                  <Link href="/independent-system-integrator/" className="text-yellow-400 hover:text-yellow-300">
