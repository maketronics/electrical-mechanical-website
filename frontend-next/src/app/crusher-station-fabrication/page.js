            ...
            <div className="space-y-6">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  <Link href="/jaw-station-integration/" className="text-yellow-400 hover:text-yellow-300 transition-colors">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  <Link href="/mechanical-systems/" className="text-yellow-400 hover:text-yellow-300 transition-colors">
