...
//   description:
//     'Contact Maketronics for crushing plant mechanical design, electrical automation, and mining system integration enquiries.',
// };
...
//   };
  ...
  try {
    ...
    Object.keys(formData).forEach((key) => {
      if (key === 'drawings') {
        if (formData.drawings && formData.drawings.length > 0) {
          formData.drawings.forEach((file) => {
