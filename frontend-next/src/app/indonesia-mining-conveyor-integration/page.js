            ...
            <div className="space-y-6">
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  <Link href="/vfd-systems-conveyors/" className="text-yellow-400 hover:text-yellow-300">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  <Link href="/crusher-discharge-chute-engineering/" className="text-yellow-400 hover:text-yellow-300">
              ...
              <article className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  <Link href="/plc-programming-quarry-plants/" className="text-yellow-400 hover:text-yellow-300">
