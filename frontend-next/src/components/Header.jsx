...
const Header = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      dropdown: [
        { name: 'Mechanical hub', href: '/mechanical-systems/' },
    ...
    },
    {
      ...
      dropdown: [
        { name: 'Electrical hub', href: '/electrical-automation/' },
    ...
    },
    {
      ...
      dropdown: [
        { name: 'Industries hub', href: '/industries-served/' },
    ...
    {
      name: 'Approach',
      href: '/execution-support/',
      dropdown: [
        { name: 'Approach hub', href: '/execution-support/' },
